export const passwordResetOtpEmailTemplate = (name: string, otp: string): string => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Reset your CallShot password</title>
  <style>
...
<body>
  <div class="wrapper">
    <div class="card">
      ...
      <!-- Body -->
      <div class="body">
        <p class="greeting">Hey ${name.split(' ')[0]}, reset your password</p>
        <p class="message">
          We received a request to reset your CallShot password. Use the code below to proceed.
        </p>
